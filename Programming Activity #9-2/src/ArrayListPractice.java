   ...
   */
   public void setModelValues( String model )
   {
    ...
    // Write your code here:
	   ...
	   {
	   car.setModel(model);
	   //animate(car, car.getMilesDriven()) uncomment this line and place proper parameters
	   }
   }
   ...
   */
   public int findMaximumMilesDriven( )
   {
    ...
    // Write your code here:
	   ...
	   for(Auto car : carList)
	   {
	   if(car.getMilesDriven() > maximum)
	   maximum = car.getMilesDriven();

	   animate(car, maximum);
	   }

	   return maximum;
 // replace this statement with your return statement
   }

...
public class MultiPathClient extends JFrame
{
   ...
   public void workWithSwitch( int value )
   {
    ...
    //
	   ...
	   case 0:
		   System.out.println("This is the integer 0!");
		   animate(0,value);
		   break;	
	   case 1:
	   ...
	   case 2:
		   System.out.println("This is the integer 2!");
		   animate(2,value);

		   break;

	   case 3:
		   System.out.println("This is the integer 3!");
		   animate(3,value);

		   break;
		   
	   case 4:
		   System.out.println("This is the integer 4!");
		   animate(4,value);

		   break;
		   
	default:
		   System.out.println("This is not one of the valid integers!");
		   animate(-1,value);
